      ...
      <div class="col-md-8 col-md-offset-2 col-xs-12">
        <div class="thumbnail">
          ...
          {else}
            ...
            <a href="crearEspecificacion/{$notebook.id_notebook}" aria-label="crear especificacion" type="button" class="btn btn-primary btn-sm">Crear Especificaciones</a>
          {/if}
          <a href="adminNotebooks" type="button" aria-label="panel admin" class="btn btn-success btn-sm">Volver</a>
        </div>
      </div>
  </div>
