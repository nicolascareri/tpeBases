          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="modificarMarca/{$marca.id_marca}" aria-label="editar marca" class="fa fa-pencil"></a></td>
                <td><a href="eliminarMarca/{$marca.id_marca}" aria-label="eliminar marca" class="fa fa-trash-o"></a></td>
              </tr>
              {/foreach}
            </tbody>
          </table>
