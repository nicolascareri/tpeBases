...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-04-2018 a las 21:31:47
...
INSERT INTO `comentario` (`id_comentario`, `fk_id_notebook`, `fk_id_usuario`, `texto_comentario`, `nota_comentario`, `fecha_comentario`) VALUES
(36, 1, 4, 'TEST', '1', '2018-04-24 13:32:31'),
(39, 4, 7, 'TEST', '1', '2018-04-24 13:35:23'),
(40, 4, 7, 'TEST', '1', '2018-04-24 13:35:25'),
(41, 3, 7, 'TEST', '1', '2018-04-24 13:35:47'),
(42, 5, 7, 'TEST', '1', '2018-04-24 13:38:27');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `especificacion_notebook`
--

CREATE TABLE `especificacion_notebook` (
...
--
-- Volcado de datos para la tabla `especificacion_notebook`
--

INSERT INTO `especificacion_notebook` (`id_notebook`, `pantalla`, `pantalla_dimension`, `peso`, `procesador`, `ram`, `memoria`, `sistema_operativo`, `conectividad`, `capacidad_bateria`, `camara`, `lector_huella`, `supercarga`) VALUES
...
INSERT INTO `imagen` (`id_imagen`, `fk_id_notebook`, `ruta`) VALUES
...
INSERT INTO `notebook` (`id_notebook`, `nombre`, `caracteristicas`, `precio`, `id_marca`) VALUES
...
(4, 'jcanneva@gmail.com', '$2y$10$OmIqFNoei0PBW.MpHSfUze.BIPcmtZHRXRZ.sR4Tya5fjR6NUAdYG', 0, 'https://ssl.gstatic.com/accounts/ui/avatar_2x.png'),
(6, 'asd@asd.asd', '$2y$10$UKnkU3/zkroOLc0sdMwt0uVEkdJVg7BQiRqacoyjHKDVdGBmoC7Ba', 0, 'https://ssl.gstatic.com/accounts/ui/avatar_2x.png'),
(7, 'asdasd@asd.com', '$2y$10$rYRq0enMh/rKutSI6TaafeCDbM..Ba975SEsTAv7/r3iHrupk0A56', 0, 'https://ssl.gstatic.com/accounts/ui/avatar_2x.png');
...
ALTER TABLE `comentario`
  ...
  ADD KEY `fk_id_notebook` (`fk_id_notebook`) USING BTREE;

--
-- Indices de la tabla `especificacion_notebook`
--
ALTER TABLE `especificacion_notebook`
  ADD PRIMARY KEY (`id_notebook`),
  ADD KEY `id_notebook` (`id_notebook`) USING BTREE;
...
ALTER TABLE `imagen`
  ...
  ADD KEY `id_notebook` (`fk_id_notebook`) USING BTREE;
...
--
ALTER TABLE `notebook`
  MODIFY `id_notebook` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `comentario`
  ADD CONSTRAINT `comentario_ibfk_1` FOREIGN KEY (`fk_id_notebook`) REFERENCES `notebook` (`id_notebook`) ON DELETE CASCADE,
...
--
-- Filtros para la tabla `especificacion_notebook`
--
ALTER TABLE `especificacion_notebook`
  ADD CONSTRAINT `especificacion_notebook_ibfk_1` FOREIGN KEY (`id_notebook`) REFERENCES `notebook` (`id_notebook`) ON DELETE CASCADE;

--
-- Filtros para la tabla `imagen`
--
ALTER TABLE `imagen`
  ADD CONSTRAINT `imagen_ibfk_1` FOREIGN KEY (`fk_id_notebook`) REFERENCES `notebook` (`id_notebook`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `notebook`
--
ALTER TABLE `notebook`
  ADD CONSTRAINT `notebook_ibfk_1` FOREIGN KEY (`id_marca`) REFERENCES `marca` (`id_marca`);
COMMIT;
